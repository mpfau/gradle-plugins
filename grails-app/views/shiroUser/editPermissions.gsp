    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: shiroUserInstance, field: 'username', 'errors')}">
                                    <g:textField name="username" value="${shiroUserInstance?.username}" disabled="disabled"/>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: shiroUserInstance, field: 'permissions', 'errors')}">
                                    <g:textArea name="permissions" value="${shiroUserInstance?.permissionString()}" rows="10" cols="60"/>
                                </td>
                            </tr>
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="updatePermissions" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
